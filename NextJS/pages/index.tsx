  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        {activeAddress && (
          <p className={inter.className}>{`Signed in: ${ellipseAddress(
            activeAddress
          )}`}</p>
        )}
        ...
        <div className={styles.grid}>
          {!activeAddress && (
            ...
            >
              ...
              <p className={inter.className}>Authenticate with PeraWallet</p>
            </a>
          )}
          ...
          {activeAddress && (
            ...
            >
              ...
              <p className={inter.className}>Logout from PeraWallet</p>
            </a>
          )}
        </div>
      </main>
